$(document).ready(function(){
  ...
  var trivia = {
    ...
    questions: {
      q1: 'Which of the following is a non metal that remains liquid at room temperature?',
      q2: 'Which of the following is used in pencils?',
      q3: 'The property of a substance to absorb moisture from the air on exposure is called?',
      q4: 'The element common to all acids is?',
      q5: "Monazite is an ore of?"
    },
    options: {
      q1: ['Phosphorous', 'Chlorine', 'Bromine', 'Helium'],
      q2: ['Graphite', 'Charcoal', 'Silicon', 'Phosphorous'],
      q3: ['Osmosis', 'Deliquescence', 'Efflorescence', 'Desiccation'],
      q4: ['Hydrogen', 'Nitrogen', 'Oxygen', 'Sulphur'],
      q5: ['Titanium','Iron','Zirconium','Thorium']
    },
    answers: {
      q1: 'Bromine',
      q2: 'Graphite',
